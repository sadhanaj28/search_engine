...
# # generic method
# @asyncio.coroutine
# def call_service(base_url, data, method):
#     url = base_url
#     response = None
#     if method == 'POST':
#         try:
...
#
# @asyncio.coroutine
# def retrieve_author_details(book_details, qry, semaphore, verbose):
#
...
#             data = yield from call_service(base_url, data, 'POST')
...
# # generic function
# @asyncio.coroutine
# def schedule_services(records_list, qry, next_calling_service, verbose, concur_req):
...
#
#
# def call_author_many(records_list, qry, verbose, concur_req):
#     loop = asyncio.new_event_loop()
#     asyncio.set_event_loop(loop)
#
#     coro = schedule_services(records_list, qry, retrieve_author_details, verbose, concur_req)
...
#     def __init__(self, document_class_name, query_list, size=None):
...
#
#             call_author_many(list_doc, qry, DEFAULT_CONCUR_REQ, MAX_CONCUR_REQ)
